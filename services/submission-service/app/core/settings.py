...
class Settings(BaseSettings):
    ...
    # --- Object storage client timeouts/retries (fail fast on slow MinIO/S3) ---
    s3_connect_timeout: int = 2
    s3_read_timeout: int = 5
    s3_max_attempts: int = 2

    # --- Own-submissions listing page size cap ---
    my_submissions_page_size: int = 50
